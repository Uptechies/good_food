...
(function (window) {
    ...
    var Jarallax = (function () {
        ...
        function Jarallax_inner(item, userOptions) {
            var _this = this,
                dataOptions;
            _this.$item = item;
            _this.defaults = { type: "scroll", speed: 0.5, imgSrc: null, imgWidth: null, imgHeight: null, elementInViewport: null, zIndex: -100, noAndroid: !1, noIos: !0, onScroll: null, onInit: null, onDestroy: null, onCoverImage: null };
    ...
    Jarallax.prototype.init = function () {
        var _this = this,
            containerStyles = { position: "absolute", top: 0, left: 0, width: "100%", height: "100%", overflow: "hidden", pointerEvents: "none" },
            imageStyles = {};
        ...
        if (_this.image.useImgTag) {
            ...
            imageStyles = _this.extend({ "background-position": "50% 50%", "background-size": "100% auto", "background-repeat": "no-repeat no-repeat", "background-image": 'url("' + _this.image.src + '")' }, containerStyles, imageStyles);
        }
        ...
        function initAfterReady() {
            ...
            setTimeout(function () {
                if (_this.$item) {
                    _this.css(_this.$item, { "background-image": "none", "background-attachment": "scroll", "background-size": "auto" });
                }
            }, 0);
        }
    ...
    Jarallax.prototype.coverImage = function () {
        ...
        _this.css(_this.image.$item, { width: resultW + "px", height: resultH + "px", marginLeft: resultML + "px", marginTop: resultMT + "px" });
