...
if ( defined( 'FW' ) ) {
	 ...
	 * Banner Options
	 */
	$header_image		 = fw_get_db_post_option( get_the_ID(), 'service_header_image' );
	$show_breadcrumb     = fw_get_db_post_option( get_the_ID(), 'service_show_breadcrumb' );
    $show_page_banner    = fw_get_db_post_option( get_the_ID(), 'show_service_banner' );
    $top_title    		 = fw_get_db_post_option( get_the_ID(), 'service_banner_top_title' );
    $page_title    		 = fw_get_db_post_option( get_the_ID(), 'service_banner_title' );
