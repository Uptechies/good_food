...
if ( defined( 'FW' ) ) {
	 ...
	 * Banner Options
	 */
	$header_image		 = fw_get_db_post_option( get_the_ID(), 'product_header_image' );
	$show_breadcrumb     = fw_get_db_post_option( get_the_ID(), 'product_show_breadcrumb' );
    $show_page_banner    = fw_get_db_post_option( get_the_ID(), 'show_product_banner' );
    $top_title    		 = fw_get_db_post_option( get_the_ID(), 'product_banner_top_title' );
    $page_title    		 = fw_get_db_post_option( get_the_ID(), 'product_banner_title' );
