 ...
 *
 * This template can be overridden by copying it to guto-lite/woocommerce/content-single-product.php.
 *
...
<div id="product-<?php the_ID(); ?>" <?php wc_product_class( '', $product ); ?>>
        ...
        <div class="summary entry-summary products-details">
            ...
            $is_social_share    = guto_lite_option( 'enable_product_share' );
            if( $is_social_share == true ):
            ...
            ?>
                <div class="products-share">
                    <ul class="social">
                        <?php if( guto_lite_option( 'product_share_title' ) != '' ): ?>
                            <li><span><?php echo esc_html( guto_lite_option( 'product_share_title' ) ); ?></span></li>
                        <?php endif; ?>

                        <?php if( guto_lite_option( 'enable_product_fb') == true ): ?>
                        ...
                        <?php if( guto_lite_option( 'enable_product_tw') == true ): ?>
                        ...
                        <?php if( guto_lite_option( 'enable_product_ld') == true ): ?>
                        ...
                        <?php if( guto_lite_option( 'enable_product_wp') == true ): ?>
                        ...
                        <?php if( guto_lite_option( 'enable_product_email') == true ): ?>
                        ...
                        <?php if( guto_lite_option( 'enable_product_cp') == true ): ?>
